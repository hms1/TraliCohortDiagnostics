...
#
# This file is part of cohortEvaluationTrali
#
...
.createCohorts <- function(connection,
  ...
  pathToCsv <- system.file("cohorts", "InclusionRules.csv", package = "cohortEvaluationTrali")
  ...
  # Instantiate cohorts:
  pathToCsv <- system.file("settings", "CohortsToCreate.csv", package = "cohortEvaluationTrali")
